...
**Scope/gap**: this mode publishes ON other domains for borrowed authority — distinct from on-site page work ([on-page-seo-checker](../../../tune/on-page-seo-checker/SKILL.md)) and from tuning your own page for answer engines ([geo-content-optimizer](../../geo-content-optimizer/SKILL.md)).
